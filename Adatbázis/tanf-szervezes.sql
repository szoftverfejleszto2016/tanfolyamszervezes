...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2021. Dec 19. 16:05
...
CREATE TABLE `jelentkezok` (
  ...
  `szulnev` varchar(60) COLLATE utf8mb4_hungarian_ci NOT NULL,
...
INSERT INTO `jelentkezok` (`jid`, `csid`, `jnev`, `szulnev`, `szulido`, `szulhely`, `anyjaneve`, `telefon`, `email`) VALUES
(1, 1, 'Kiss Gizella', 'Kiss Gizella', '2000-06-02', 'Budapest', 'Németh Gizella', '+36702996724', 'kissg@freemail.hu'),
(2, 1, 'Nagy Béla', 'Nagy Béla', '1991-01-12', 'Budapest', 'Kovács Lujza', '+36302986724', 'nagyb@freemail.hu'),
(3, 2, 'Kovács Lajos', 'Kovács Lajos', '1986-07-30', 'Miskolc', 'Fekete Erzsébet', '+36202976724', 'kovacslajos@gmail.hu'),
(4, 2, 'Szabó Géza', 'Szabó Géza', '2001-03-12', 'Budapest', 'Piros Piroska', '+36301996724', 'gezasz@gmail.hu'),
(5, 2, 'Fekete Mihály', 'Fekete Mihály', '1993-11-23', 'Budapest', 'Kék Klára', '+36201996723', 'fekete@freemail.hu'),
(6, 3, 'Kovácsné Fehér Ágnes', 'Fehér Ágnes', '1978-01-30', 'Eger', 'Barna Éva', '+3670196724', 'kfeheragi@freemail.hu'),
(7, 3, 'Magyar Márton', 'Magyar Márton', '2000-09-01', 'Budapest', 'Kiss Virág', '+36302996724', 'magyarm@gmail.hu'),
(8, 3, 'Németh István', 'Németh István', '1998-04-01', 'Budapest', 'Bazsa Rózsa', '+36302996724', 'nemeth.istvan@gmail.hu'),
(9, 3, 'Orosz Gabriella', 'Orosz Gabriella', '2000-06-02', 'Budapest', 'Tóth Ibolya', '+36202996724', 'oroszg@gmail.hu'),
(10, 3, 'Széles Gáborné', 'Keskeny Klára', '1982-06-12', 'Budapest', 'Nagy Katalin', '+36202996724', 'szeles@gmail.hu'),
(11, 3, 'Kocka József', 'Kocka József', '1992-10-13', 'Szeged', 'Szabó Sarolta', '+36702997724', 'kocka2@gmail.hu'),
(12, 3, 'Fazekas Attila', 'Fazekas Attila', '2001-12-02', 'Budapest', 'Tóth Zoé', '+36702996720', 'fazekas@freemail.hu'),
(13, 3, 'Asztalos Szilvia', 'Asztalos Szilvia', '2000-05-01', 'Győr', 'Fazekas Anna', '+36302996714', 'asztalos@freemail.hu'),
(14, 4, 'Tóth Krisztina', 'Tóth Krisztina', '1991-11-07', 'Budapest', 'Papp Ildikó', '+36702996725', 'kriszti1991@gmail.hu'),
(15, 4, 'Nagy János', 'Nagy János', '1989-06-20', 'Budapest', 'Horváth Orsolya', '+36302996711', 'nagyjanos@gmail.hu'),
(16, 4, 'Soós Sándor', 'Soós Sándor', '2000-07-29', 'Budapest', 'Román Róbert', '+36302996713', 'sooss@freemail.hu'),
(17, 4, 'Kis Zsolt', 'Kis Zsolt', '1994-02-10', 'Debrecen', 'Kósa Renáta', '+36202995724', 'kiszsolt@gmail.hu'),
(18, 4, 'Simon Lajos', 'Simon Lajos', '1965-04-18', 'Budapest', 'Homoki Andrea', '+36202994724', 'simonlajos@gmail.hu');
